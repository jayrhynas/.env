...
hi default ShowMarksHLl ctermfg=darkgray ctermbg=0 cterm=bold guifg=gray guibg=bg gui=bold
hi default ShowMarksHLu ctermfg=darkgray ctermbg=0 cterm=bold guifg=gray guibg=bg gui=bold
hi default ShowMarksHLo ctermfg=darkgray ctermbg=0 cterm=bold guifg=gray guibg=bg gui=bold
hi default ShowMarksHLm ctermfg=darkgray ctermbg=0 cterm=bold guifg=gray guibg=bg gui=bold

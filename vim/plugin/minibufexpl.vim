...
function! <SID>StartExplorer(sticky,delBufNum,currBufName)
  ...
  " If you middle click in the -MiniBufExplorer- then try
  " to delete the clicked buffer
  nnoremap <buffer> <MiddleMouse> :call <SID>MBEDeleteBuffer(bufname("#"))<CR>:<BS>
